...
//    Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJkdW1teTFAZ21haWwuY29tIiwiaWF0IjoxNzU1MzM1NDMyLCJleHAiOjE3NTUzMzkwMzIsInVzZXJ0eXBlIjoiVVNFUiJ9.5vJrdo3oKEIVsqcs05xnf8IsYIouXIqI93wqy7Uj1QE
    ...
    public BookingResponseDTO updateBookingStatus(@PathVariable Long id, HttpServletRequest request) {
        String email = extractEmailFromToken(request);
        return bookingService.updateBookingStatus(id, email);
    }
